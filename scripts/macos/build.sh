...
for f in ../Modules/*.c; do
  gcc -Wall -Wextra -std=c11 -O2 -c "$f" -o "$(basename "${f%.c}").o"
done

echo "Linking..."
gcc main.o lexer.o parser.o ast.o interpreter.o typechecker.o module.o modules_registry.o \
  string_mod.o random_mod.o atomics_mod.o -o rubolt -lm

popd >/dev/null

echo "Done. Binary at src/rubolt"
