...
gcc main.o lexer.o parser.o ast.o interpreter.o typechecker.o module.o modules_registry.o bc_compiler.o vm.o dll_loader.o dll_import.o native_registry.o manager.o bopes.o gc.o type_info.o rc.o ^
